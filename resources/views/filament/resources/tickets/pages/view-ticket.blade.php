                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="flex items-center space-x-3">
                        <div class="bg-blue-100 rounded-lg p-2">
                            <x-filament::icon icon="heroicon-o-user" class="w-5 h-5 text-blue-600" />
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Requester</p>
                            <p class="font-medium text-gray-900">{{ $this->record->user->name }}</p>
                        </div>
                    </div>
                        ...
                        <form wire:submit="addComment">
                            ...
                            <div class="flex justify-between items-center mt-4">
                                ...
                                <x-filament::button type="submit">
                                    ...
                                    {{ auth()->user()->hasRole(['super_admin', 'admin', 'agent']) ? 'Send Response' : 'Send Message' }}
                                </x-filament::button>
                            </div>
                        </form>
                    </div>
