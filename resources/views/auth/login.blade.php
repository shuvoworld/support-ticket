...
<body>
        ...
        <div class="w-full max-w-2xl fade-in">
            ...
            <div class="filament-card-enhanced p-12 slide-up">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-lg text-gray-600">Sign in to your support ticket account</p>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input type="checkbox" id="remember" name="remember"
                                   class="filament-checkbox-enhanced">
                            <label for="remember" class="ml-3 text-sm text-gray-600 font-medium">
                                Remember me
                            </label>
                        </div>
                    ...
                    @if ($errors->any())
                        <div class="filament-alert-enhanced filament-alert-danger-enhanced" role="alert">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="font-medium">Login failed</h3>
    ...
    <script>
        ...
        // Show success message on page load if redirected from successful registration
